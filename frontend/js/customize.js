      ...
      (ingredient, index) => `
                <div class="ingredient-card">
                    <div class="ingredient-header">
                        ...
                        <span class="tooltip" data-tooltip="Original: ${
                    ...
                    <div class="ingredient-controls">
                        <div class="control-group">
                            ...
                            <select class="custom-select" data-ingredient="${index}" data-field="measurementType">
                                <option value="sifted" ${
                                  ingredient.measurementType === "sifted"
                                    ? "selected"
                                    : ""
                                }>Sifted</option>
                                <option value="packed" ${
                                  ingredient.measurementType === "packed"
                                    ? "selected"
                                    : ""
                                }>Packed</option>
                                <option value="leveled" ${
                                  ingredient.measurementType === "leveled"
                                    ? "selected"
                                    : ""
                                }>Leveled</option>
                                <option value="heaped" ${
                                  ingredient.measurementType === "heaped"
                                    ? "selected"
                                    : ""
                                }>Heaped</option>
                                <option value="melted" ${
                                  ingredient.measurementType === "melted"
                                    ? "selected"
                                    : ""
                                }>Melted</option>
                                <option value="softened" ${
                                  ingredient.measurementType === "softened"
                                    ? "selected"
                                    : ""
                                }>Softened</option>
                                <option value="liquid" ${
                                  ingredient.measurementType === "liquid"
                                    ? "selected"
                                    : ""
                                }>Liquid</option>
                            </select>
...
function loadBrandPreference() {
  ...
  document
    .querySelector(`[data-brand="${savedBrand}"]`)
